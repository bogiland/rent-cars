...
export function FeaturedFleet() {
  const affordable = [...allCars]
    .sort((a, b) => a.pricePerDay - b.pricePerDay)
    .slice(0, 8);
  const luxury = [...allCars]
    .filter((car) =>
      ["Luxury", "Supercars", "SUV Premium", "Sports"].includes(car.category),
    )
    .slice(0, 8);
      ...
      <div className="container py-5 md:py-6">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-center px-6 py-5 md:px-10">
            <p className="text-xl font-bold text-[var(--color-fg)] md:text-2xl">
              Lease for 6 Months
            </p>
            <p className="mt-1 max-w-xl text-sm font-medium text-[var(--color-fg-muted)]">
              BMW, Mercedes, Kia and Hyundai rentals with full insurance and
              airport delivery.
            </p>
